    ...
    <section class="relative py-20 bg-white overflow-hidden" id="sejarah">
        ...
        <div class="absolute inset-0 z-0">
            ...
            <img src="https://images.unsplash.com/photo-1441974231531-c6227db76b6e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80" loading="lazy" alt="Background Forest" class="w-full h-full object-cover transform scale-105 parallax-bg"
                data-speed="0.3">
        </div>
